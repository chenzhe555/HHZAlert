#
#  Be sure to run `pod spec lint HHZAlert.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "陈哲是个好孩子-Alert"

  s.homepage     = "https://github.com/chenzhe555/HHZAlert"
  ...
  s.source       = { :git => "https://github.com/chenzhe555/HHZAlert.git", :tag => "#{s.version}" }
